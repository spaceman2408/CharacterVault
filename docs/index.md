...
- **Edit every field** of a V2/V3 character card, from description and personality to greetings and lorebook
- **Use AI to help you write** with Orion, a built-in chat assistant, and an AI toolbar that can enhance, rephrase, shorten, fix, search, resize text, and normalize HTML entities inline
